...
const PATHS = {
  ...
  [JOB_KIND.VM_RESTORE]: (jobId) => `/api/vms/backup-progress/${encodeURIComponent(jobId)}`,
  [JOB_KIND.CONTAINER_RESTORE]: (jobId) => `/api/containers/backup-progress/${encodeURIComponent(jobId)}`,
