...
import { Loader2, RefreshCw, ArrowUpCircle, X, Package, CheckCircle, AlertCircle, Clock } from 'lucide-react';
...
export default function HostMgmt() {
  ...
  // Derive a single status to show below the header row.
  // Priority: errors > upgrade success > manual check result > background count.
  let status = null;
  if (upgradeError) {
