  ...
  build: {
    rolldownOptions: {
      ...
      output: {
        ...
        // — the bundler's default behaviour groups them into their
        // dynamic-import parent's chunk, so they only ship when the user
        // actually opens that view. Bundling them into `vendor` would
        // re-merge them into the eager bundle and inflate it past 500 kB.
        // The `[\\/]` terminators keep react-markdown & co. from matching.
        codeSplitting: {
          groups: [
            {
              name: 'vendor',
